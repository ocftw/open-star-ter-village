...
layout_list:
  ...
  - type: layout_section
    title: 如何使用桌遊
    columns:
      - text: 淺顯易懂的桌遊規則，配上精美的懶人包[教學簡報](https://drive.google.com/file/d/15gHBeMmm_u4Gz62V0TCwTPn7M31-rwEc/view)，讓想參與桌遊的你快速上手！
        title: 我是桌遊(新手)玩家
      - title: 我是教育者
        text: >-
          **將桌遊融入教案，帶學生認識開源**
          ...
          OCF 推出[免費租借桌遊專案](https://drive.google.com/file/d/120Fbj4QsPwRsWWxCkzCGqmImDnbfgjlB/view?usp=drive_link)與搭配的[教案](https://drive.google.com/file/d/1ELu5H1MhJM1O8C8gSvsM9Opga8VARLRf/view?usp=drive_link)，邀請教育者們一同將開源理念帶入課堂，讓同學透過桌遊，更認識開源，理解協作、專案管理、資源共享、多元能力的重要性。


          **推廣議題**


          打破科系限制！只要是公共政策、開放政府、公共議題相關課程，都可從開源星手村認識開源精神，帶領學生討論如何更有效益推廣議題，解決問題。
      ...
      - title: 窩是學生
        text: 想來場集結歡樂與意義的冒險嗎？開源星手村桌遊，是你好用的歡樂神器！不論是團康遊戲、社團破冰、聯誼聚會，百搭萬用。讓你無痛上手桌遊的趣味，同時兼顧公共議題討論的精神，一同體驗開源協作樂趣！
      - title: 給進階玩家
  ...
  - type: layout_section
    ...
    columns:
      - text: |-
          我們正在招兵買馬中，只要你也是桌遊愛好者、想嘗試開源專案的的好朋友，歡迎與我們一起開發線上桌遊。

          加入我們的 discord 一起遊戲開發！
        title: ""
  - type: layout_section
