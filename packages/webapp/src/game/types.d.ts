...
declare global {
  declare namespace OpenStarTerVillageType {
    type JobName = string;
    ...
    export declare namespace Move {
      ...
      export type Contribution = { activeProjectIndex: number; jobName: JobName; value: number }
      ...
      export type ContributeOwnedProjects = (contributions: Contribution[]) => void;
      export type ContributeJoinedProjects = (contributions: Contribution[]) => void;
