...
const gameFeatureDataColumns = [
  ...
  [`尋找志同道合的夥伴`, `
      ...
      在面對問題的路上有不懂的地方就去找人來幫忙，工程師不會寫的文案、不了解的法案、不會唸的發音、不了解的議題、不會畫的美術，七種技能的角色卡，各自發揮所長，完美解決開發科技工具的多元需求！
      </div>`],
]
...
const Index = () => (
  <Base data={{ ...siteData, social: socialData, nav: navigationList }}>
    ...
    <ThreeColumns
      ...
      title={`遊戲用途與目的`}
      columns={[
        [`教學教材`, `無論大學、高中課程或相關社團課程，教學簡報配合桌遊，輕鬆認識開源觀念！`],
        [`社群推坑`, `已是開源老手、社群活躍成員的你，想要不費吹灰之力吸收新血？揪團玩就對了！`],
        [`自娛娛人`, `角色可愛就給我來一打！`],
      ]}
    />
    <ThreeColumns
